...
echo 7. urban_notraffic.py   - Slow speed, suburb and city area, no car 
...
echo Quit sim using [End] key OR [Window] + right click close all 
echo If non responsive, launch task manager and kill the process 
cd /d "%python_path%"
