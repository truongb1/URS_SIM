...
local function toggleSecondView()
  ...
  print("camNodeID:", camNodeID)
  
  local view = {
    name = "Top view",
    position = vec3(0.3, 0, 15),
    offsetNode = camNodeID or 0,
    rotation = quatFromEuler(math.rad(90), 0, 0),
    resolutionX = output.width/2, resolutionY = output.height,
    renderDetail = 0.3,
    fov = 45,
    nearClip = 0.1, farClip = 1500,
    enableShadows = 0,
    ...
    local view2 = {
    name = "Out view",
    position = vec3(0.3, -10, 1),
    offsetNode = camNodeID or 0,
    rotation = quatFromEuler(math.rad(10), 0, 0),
    resolutionX = output.width/2, resolutionY = output.height,
    renderDetail = 0.3,
    fov = 45,
  ...
  extensions.tech_multiscreen.addView(view2)
